 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(n){function e(D,F){var R=D.length;D.push(F);e:for(;0<R;){var $=R-1>>>1,Q=D[$];if(0<r(Q,F))D[$]=F,D[R]=Q,R=$;else break e}}function t(D){return D.length===0?null:D[0]}function i(D){if(D.length===0)return null;var F=D[0],R=D.pop();if(R!==F){D[0]=R;e:for(var $=0,Q=D.length,j=Q>>>1;$<j;){var K=2*($+1)-1,ie=D[K],fe=K+1,le=D[fe];if(0>r(ie,R))fe<Q&&0>r(le,ie)?(D[$]=le,D[fe]=R,$=fe):(D[$]=ie,D[K]=R,$=K);else if(fe<Q&&0>r(le,R))D[$]=le,D[fe]=R,$=fe;else break e}}return F}function r(D,F){var R=D.sortIndex-F.sortIndex;return R!==0?R:D.id-F.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;n.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();n.unstable_now=function(){return o.now()-a}}var l=[],u=[],c=1,f=null,d=3,p=!1,_=!1,g=!1,m=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,v=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function x(D){for(var F=t(u);F!==null;){if(F.callback===null)i(u);else if(F.startTime<=D)i(u),F.sortIndex=F.expirationTime,e(l,F);else break;F=t(u)}}function y(D){if(g=!1,x(D),!_)if(t(l)!==null)_=!0,B(T);else{var F=t(u);F!==null&&H(y,F.startTime-D)}}function T(D,F){_=!1,g&&(g=!1,h(P),P=-1),p=!0;var R=d;try{for(x(F),f=t(l);f!==null&&(!(f.expirationTime>F)||D&&!N());){var $=f.callback;if(typeof $=="function"){f.callback=null,d=f.priorityLevel;var Q=$(f.expirationTime<=F);F=n.unstable_now(),typeof Q=="function"?f.callback=Q:f===t(l)&&i(l),x(F)}else i(l);f=t(l)}if(f!==null)var j=!0;else{var K=t(u);K!==null&&H(y,K.startTime-F),j=!1}return j}finally{f=null,d=R,p=!1}}var w=!1,S=null,P=-1,M=5,E=-1;function N(){return!(n.unstable_now()-E<M)}function I(){if(S!==null){var D=n.unstable_now();E=D;var F=!0;try{F=S(!0,D)}finally{F?Z():(w=!1,S=null)}}else w=!1}var Z;if(typeof v=="function")Z=function(){v(I)};else if(typeof MessageChannel<"u"){var L=new MessageChannel,O=L.port2;L.port1.onmessage=I,Z=function(){O.postMessage(null)}}else Z=function(){m(I,0)};function B(D){S=D,w||(w=!0,Z())}function H(D,F){P=m(function(){D(n.unstable_now())},F)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(D){D.callback=null},n.unstable_continueExecution=function(){_||p||(_=!0,B(T))},n.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):M=0<D?Math.floor(1e3/D):5},n.unstable_getCurrentPriorityLevel=function(){return d},n.unstable_getFirstCallbackNode=function(){return t(l)},n.unstable_next=function(D){switch(d){case 1:case 2:case 3:var F=3;break;default:F=d}var R=d;d=F;try{return D()}finally{d=R}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=function(){},n.unstable_runWithPriority=function(D,F){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var R=d;d=D;try{return F()}finally{d=R}},n.unstable_scheduleCallback=function(D,F,R){var $=n.unstable_now();switch(typeof R=="object"&&R!==null?(R=R.delay,R=typeof R=="number"&&0<R?$+R:$):R=$,D){case 1:var Q=-1;break;case 2:Q=250;break;case 5:Q=1073741823;break;case 4:Q=1e4;break;default:Q=5e3}return Q=R+Q,D={id:c++,callback:F,priorityLevel:D,startTime:R,expirationTime:Q,sortIndex:-1},R>$?(D.sortIndex=R,e(u,D),t(l)===null&&D===t(u)&&(g?(h(P),P=-1):g=!0,H(y,R-$))):(D.sortIndex=Q,e(l,D),_||p||(_=!0,B(T))),D},n.unstable_shouldYield=N,n.unstable_wrapCallback=function(D){var F=d;return function(){var R=d;d=F;try{return D.apply(this,arguments)}finally{d=R}}}})(ny);ty.exports=ny;var $T=ty.exports;/**
 * @license React
