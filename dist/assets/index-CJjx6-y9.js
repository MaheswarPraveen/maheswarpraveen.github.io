	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}al.BlurDirectionX=new Ze(1,0);al.BlurDirectionY=new Ze(0,1);Xu.registerPlugin(Qe);function A3(){const n=bo.useRef(null);return bo.useEffect(()=>{const e=n.current;if(!e)return;function t(){const fe=document.createElement("canvas");fe.width=64,fe.height=64;const b=fe.getContext("2d"),A=b.createRadialGradient(32,32,0,32,32,32);A.addColorStop(0,"rgba(255, 255, 255, 1.0)"),A.addColorStop(.2,"rgba(255, 235, 170, 0.95)"),A.addColorStop(.5,"rgba(255, 130, 30, 0.5)"),A.addColorStop(.8,"rgba(220, 50, 0, 0.15)"),A.addColorStop(1,"rgba(0, 0, 0, 0)"),b.fillStyle=A,b.beginPath(),b.arc(32,32,32,0,Math.PI*2),b.fill();const k=new _3(fe);return k.generateMipmaps=!1,k.minFilter=$n,k.magFilter=$n,k.needsUpdate=!0,k}const i=t(),r=7,s=new X(r,0,0),o=new g3,a=new Hi(45,window.innerWidth/window.innerHeight,.1,1e3),l=new h1({canvas:e,antialias:!0,alpha:!0});l.setSize(window.innerWidth,window.innerHeight),l.setPixelRatio(Math.min(window.devicePixelRatio,1.5)),l.toneMapping=FE,l.toneMappingExposure=1.2,l.setClearColor(0,0);const u=new Ki(window.innerWidth,window.innerHeight,{type:Ar,format:Gi}),c=new E3(l,u);c.addPass(new T3(o,a));const d=new al(new Ze(window.innerWidth,window.innerHeight),.85,.55,.15);c.addPass(d);const h={uniforms:{tDiffuse:{value:null},bhPos:{value:new Ze(.5,.5)},strength:{value:.0015}},vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
          gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
