 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(n){function e(U,O){var R=U.length;U.push(O);e:for(;0<R;){var $=R-1>>>1,Q=U[$];if(0<r(Q,O))U[$]=O,U[R]=Q,R=$;else break e}}function t(U){return U.length===0?null:U[0]}function i(U){if(U.length===0)return null;var O=U[0],R=U.pop();if(R!==O){U[0]=R;e:for(var $=0,Q=U.length,q=Q>>>1;$<q;){var K=2*($+1)-1,re=U[K],me=K+1,ue=U[me];if(0>r(re,R))me<Q&&0>r(ue,re)?(U[$]=ue,U[me]=R,$=me):(U[$]=re,U[K]=R,$=K);else if(me<Q&&0>r(ue,R))U[$]=ue,U[me]=R,$=me;else break e}}return O}function r(U,O){var R=U.sortIndex-O.sortIndex;return R!==0?R:U.id-O.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;n.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();n.unstable_now=function(){return o.now()-a}}var l=[],u=[],c=1,f=null,h=3,p=!1,v=!1,g=!1,m=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,_=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function x(U){for(var O=t(u);O!==null;){if(O.callback===null)i(u);else if(O.startTime<=U)i(u),O.sortIndex=O.expirationTime,e(l,O);else break;O=t(u)}}function y(U){if(g=!1,x(U),!v)if(t(l)!==null)v=!0,V(w);else{var O=t(u);O!==null&&B(y,O.startTime-U)}}function w(U,O){v=!1,g&&(g=!1,d(P),P=-1),p=!0;var R=h;try{for(x(O),f=t(l);f!==null&&(!(f.expirationTime>O)||U&&!F());){var $=f.callback;if(typeof $=="function"){f.callback=null,h=f.priorityLevel;var Q=$(f.expirationTime<=O);O=n.unstable_now(),typeof Q=="function"?f.callback=Q:f===t(l)&&i(l),x(O)}else i(l);f=t(l)}if(f!==null)var q=!0;else{var K=t(u);K!==null&&B(y,K.startTime-O),q=!1}return q}finally{f=null,h=R,p=!1}}var T=!1,M=null,P=-1,S=5,E=-1;function F(){return!(n.unstable_now()-E<S)}function N(){if(M!==null){var U=n.unstable_now();E=U;var O=!0;try{O=M(!0,U)}finally{O?Z():(T=!1,M=null)}}else T=!1}var Z;if(typeof _=="function")Z=function(){_(N)};else if(typeof MessageChannel<"u"){var L=new MessageChannel,I=L.port2;L.port1.onmessage=N,Z=function(){I.postMessage(null)}}else Z=function(){m(N,0)};function V(U){M=U,T||(T=!0,Z())}function B(U,O){P=m(function(){U(n.unstable_now())},O)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(U){U.callback=null},n.unstable_continueExecution=function(){v||p||(v=!0,V(w))},n.unstable_forceFrameRate=function(U){0>U||125<U?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):S=0<U?Math.floor(1e3/U):5},n.unstable_getCurrentPriorityLevel=function(){return h},n.unstable_getFirstCallbackNode=function(){return t(l)},n.unstable_next=function(U){switch(h){case 1:case 2:case 3:var O=3;break;default:O=h}var R=h;h=O;try{return U()}finally{h=R}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=function(){},n.unstable_runWithPriority=function(U,O){switch(U){case 1:case 2:case 3:case 4:case 5:break;default:U=3}var R=h;h=U;try{return O()}finally{h=R}},n.unstable_scheduleCallback=function(U,O,R){var $=n.unstable_now();switch(typeof R=="object"&&R!==null?(R=R.delay,R=typeof R=="number"&&0<R?$+R:$):R=$,U){case 1:var Q=-1;break;case 2:Q=250;break;case 5:Q=1073741823;break;case 4:Q=1e4;break;default:Q=5e3}return Q=R+Q,U={id:c++,callback:O,priorityLevel:U,startTime:R,expirationTime:Q,sortIndex:-1},R>$?(U.sortIndex=R,e(u,U),t(l)===null&&U===t(u)&&(g?(d(P),P=-1):g=!0,B(y,R-$))):(U.sortIndex=Q,e(l,U),v||p||(v=!0,V(w))),U},n.unstable_shouldYield=F,n.unstable_wrapCallback=function(U){var O=h;return function(){var R=h;h=O;try{return U.apply(this,arguments)}finally{h=R}}}})(ey);Jx.exports=ey;var B1=Jx.exports;/**
 * @license React
 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var F0,gs,Oa,qg,fo,k0,$g,HA=function(){return typeof window<"u"},Zr={},no=180/Math.PI,Fa=Math.PI/180,Go=Math.atan2,z0=1e8,Kg=/([A-Z])/g,VA=/(left|right|width|margin|padding|x)/i,GA=/[\s,\(]\S/,yr={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},um=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},WA=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},XA=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},YA=function(e,t){return t.set(t.t,t.p,e===1?t.e:e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},jA=function(e,t){var i=t.s+t.c*e;t.set(t.t,t.p,~~(i+(i<0?-.5:.5))+t.u,t)},kM=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},zM=function(e,t){return t.set(t.t,t.p,e!==1?t.b:t.e,t)},qA=function(e,t,i){return e.style[t]=i},$A=function(e,t,i){return e.style.setProperty(t,i)},KA=function(e,t,i){return e._gsap[t]=i},ZA=function(e,t,i){return e._gsap.scaleX=e._gsap.scaleY=i},QA=function(e,t,i,r,s){var o=e._gsap;o.scaleX=o.scaleY=i,o.renderTransform(s,o)},JA=function(e,t,i,r,s){var o=e._gsap;o[t]=i,o.renderTransform(s,o)},Ft="transform",si=Ft+"Origin",eC=function n(e,t){var i=this,r=this.target,s=r.style,o=r._gsap;if(e in Zr&&s){if(this.tfm=this.tfm||{},e!=="transform")e=yr[e]||e,~e.indexOf(",")?e.split(",").forEach(function(a){return i.tfm[a]=Fr(r,a)}):this.tfm[e]=o.x?o[e]:Fr(r,e),e===si&&(this.tfm.zOrigin=o.zOrigin);else return yr.transform.split(",").forEach(function(a){return n.call(i,a,t)});if(this.props.indexOf(Ft)>=0)return;o.svg&&(this.svgo=r.getAttribute("data-svg-origin"),this.props.push(si,t,"")),e=Ft}(s||t)&&this.props.push(e,t,s[e])},BM=function(e){e.translate&&(e.removeProperty("translate"),e.removeProperty("scale"),e.removeProperty("rotate"))},tC=function(){var e=this.props,t=this.target,i=t.style,r=t._gsap,s,o;for(s=0;s<e.length;s+=3)e[s+1]?e[s+1]===2?t[e[s]](e[s+2]):t[e[s]]=e[s+2]:e[s+2]?i[e[s]]=e[s+2]:i.removeProperty(e[s].substr(0,2)==="--"?e[s]:e[s].replace(Kg,"-$1").toLowerCase());if(this.tfm){for(o in this.tfm)r[o]=this.tfm[o];r.svg&&(r.renderTransform(),t.setAttribute("data-svg-origin",this.svgo||"")),s=$g(),(!s||!s.isStart)&&!i[Ft]&&(BM(i),r.zOrigin&&i[si]&&(i[si]+=" "+r.zOrigin+"px",r.zOrigin=0,r.renderTransform()),r.uncache=1)}},HM=function(e,t){var i={target:e,props:[],revert:tC,save:eC};return e._gsap||ui.core.getCache(e),t&&e.style&&e.nodeType&&t.split(",").forEach(function(r){return i.save(r)}),i},VM,cm=function(e,t){var i=gs.createElementNS?gs.createElementNS((t||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),e):gs.createElement(e);return i&&i.style?i:gs.createElement(e)},Mi=function n(e,t,i){var r=getComputedStyle(e);return r[t]||r.getPropertyValue(t.replace(Kg,"-$1").toLowerCase())||r.getPropertyValue(t)||!i&&n(e,tl(t)||t,1)||""},B0="O,Moz,ms,Ms,Webkit".split(","),tl=function(e,t,i){var r=t||fo,s=r.style,o=5;if(e in s&&!i)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);o--&&!(B0[o]+e in s););return o<0?null:(o===3?"ms":o>=0?B0[o]:"")+e},fm=function(){HA()&&window.document&&(F0=window,gs=F0.document,Oa=gs.documentElement,fo=cm("div")||{style:{}},cm("div"),Ft=tl(Ft),si=Ft+"Origin",fo.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",VM=!!tl("perspective"),$g=ui.core.reverting,qg=1)},H0=function(e){var t=e.ownerSVGElement,i=cm("svg",t&&t.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),r=e.cloneNode(!0),s;r.style.display="block",i.appendChild(r),Oa.appendChild(i);try{s=r.getBBox()}catch{}return i.removeChild(r),Oa.removeChild(i),s},V0=function(e,t){for(var i=t.length;i--;)if(e.hasAttribute(t[i]))return e.getAttribute(t[i])},GM=function(e){var t,i;try{t=e.getBBox()}catch{t=H0(e),i=1}return t&&(t.width||t.height)||i||(t=H0(e)),t&&!t.width&&!t.x&&!t.y?{x:+V0(e,["x","cx","x1"])||0,y:+V0(e,["y","cy","y1"])||0,width:0,height:0}:t},WM=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&GM(e))},ks=function(e,t){if(t){var i=e.style,r;t in Zr&&t!==si&&(t=Ft),i.removeProperty?(r=t.substr(0,2),(r==="ms"||t.substr(0,6)==="webkit")&&(t="-"+t),i.removeProperty(r==="--"?t:t.replace(Kg,"-$1").toLowerCase())):i.removeAttribute(t)}},_s=function(e,t,i,r,s,o){var a=new ri(e._pt,t,i,0,1,o?zM:kM);return e._pt=a,a.b=r,a.e=s,e._props.push(i),a},G0={deg:1,rad:1,turn:1},nC={grid:1,flex:1},zs=function n(e,t,i,r){var s=parseFloat(i)||0,o=(i+"").trim().substr((s+"").length)||"px",a=fo.style,l=VA.test(t),u=e.tagName.toLowerCase()==="svg",c=(u?"client":"offset")+(l?"Width":"Height"),f=100,h=r==="px",p=r==="%",v,g,m,d;if(r===o||!s||G0[r]||G0[o])return s;if(o!=="px"&&!h&&(s=n(e,t,i,"px")),d=e.getCTM&&WM(e),(p||o==="%")&&(Zr[t]||~t.indexOf("adius")))return v=d?e.getBBox()[l?"width":"height"]:e[c],Gt(p?s/v*f:s/100*v);if(a[l?"width":"height"]=f+(h?o:r),g=r!=="rem"&&~t.indexOf("adius")||r==="em"&&e.appendChild&&!u?e:e.parentNode,d&&(g=(e.ownerSVGElement||{}).parentNode),(!g||g===gs||!g.appendChild)&&(g=gs.body),m=g._gsap,m&&p&&m.width&&l&&m.time===vi.time&&!m.uncache)return Gt(s/m.width*f);if(p&&(t==="height"||t==="width")){var _=e.style[t];e.style[t]=f+r,v=e[c],_?e.style[t]=_:ks(e,t)}else(p||o==="%")&&!nC[Mi(g,"display")]&&(a.position=Mi(e,"position")),g===e&&(a.position="static"),g.appendChild(fo),v=fo[c],g.removeChild(fo),a.position="absolute";return l&&p&&(m=xo(g),m.time=vi.time,m.width=g[c]),Gt(h?v*s/f:v&&s?f/v*s:0)},Fr=function(e,t,i,r){var s;return qg||fm(),t in yr&&t!=="transform"&&(t=yr[t],~t.indexOf(",")&&(t=t.split(",")[0])),Zr[t]&&t!=="transform"?(s=Iu(e,r),s=t!=="transformOrigin"?s[t]:s.svg?s.origin:ed(Mi(e,si))+" "+s.zOrigin+"px"):(s=e.style[t],(!s||s==="auto"||r||~(s+"").indexOf("calc("))&&(s=Jf[t]&&Jf[t](e,t,i)||Mi(e,t)||lM(e,t)||(t==="opacity"?1:0))),i&&!~(s+"").trim().indexOf(" ")?zs(e,t,s,i)+i:s},iC=function(e,t,i,r){if(!i||i==="none"){var s=tl(t,e,1),o=s&&Mi(e,s,1);o&&o!==i?(t=s,i=o):t==="borderColor"&&(i=Mi(e,"borderTopColor"))}var a=new ri(this._pt,e.style,t,0,1,IM),l=0,u=0,c,f,h,p,v,g,m,d,_,x,y,w;if(a.b=i,a.e=r,i+="",r+="",r.substring(0,6)==="var(--"&&(r=Mi(e,r.substring(4,r.indexOf(")")))),r==="auto"&&(g=e.style[t],e.style[t]=r,r=Mi(e,t)||r,g?e.style[t]=g:ks(e,t)),c=[i,r],CM(c),i=c[0],r=c[1],h=i.match(Ta)||[],w=r.match(Ta)||[],w.length){for(;f=Ta.exec(r);)m=f[0],_=r.substring(l,f.index),v?v=(v+1)%5:(_.substr(-5)==="rgba("||_.substr(-5)==="hsla(")&&(v=1),m!==(g=h[u++]||"")&&(p=parseFloat(g)||0,y=g.substr((p+"").length),m.charAt(1)==="="&&(m=Ia(p,m)+y),d=parseFloat(m),x=m.substr((d+"").length),l=Ta.lastIndex-x.length,x||(x=x||Ai.units[t]||y,l===r.length&&(r+=x,a.e+=x)),y!==x&&(p=zs(e,t,g,x)||0),a._pt={_next:a._pt,p:_||u===1?_:",",s:p,c:d-p,m:v&&v<4||t==="zIndex"?Math.round:0});a.c=l<r.length?r.substring(l,r.length):""}else a.r=t==="display"&&r==="none"?zM:kM;return iM.test(r)&&(a.e=0),this._pt=a,a},W0={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},rC=function(e){var t=e.split(" "),i=t[0],r=t[1]||"50%";return(i==="top"||i==="bottom"||r==="left"||r==="right")&&(e=i,i=r,r=e),t[0]=W0[i]||i,t[1]=W0[r]||r,t.join(" ")},sC=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var i=t.t,r=i.style,s=t.u,o=i._gsap,a,l,u;if(s==="all"||s===!0)r.cssText="",l=1;else for(s=s.split(","),u=s.length;--u>-1;)a=s[u],Zr[a]&&(l=1,a=a==="transformOrigin"?si:Ft),ks(i,a);l&&(ks(i,Ft),o&&(o.svg&&i.removeAttribute("transform"),r.scale=r.rotate=r.translate="none",Iu(i,1),o.uncache=1,BM(r)))}},Jf={clearProps:function(e,t,i,r,s){if(s.data!=="isFromStart"){var o=e._pt=new ri(e._pt,t,i,0,0,sC);return o.u=r,o.pr=-10,o.tween=s,e._props.push(i),1}}},Nu=[1,0,0,1,0,0],XM={},YM=function(e){return e==="matrix(1, 0, 0, 1, 0, 0)"||e==="none"||!e},X0=function(e){var t=Mi(e,Ft);return YM(t)?Nu:t.substr(7).match(nM).map(Gt)},Zg=function(e,t){var i=e._gsap||xo(e),r=e.style,s=X0(e),o,a,l,u;return i.svg&&e.getAttribute("transform")?(l=e.transform.baseVal.consolidate().matrix,s=[l.a,l.b,l.c,l.d,l.e,l.f],s.join(",")==="1,0,0,1,0,0"?Nu:s):(s===Nu&&!e.offsetParent&&e!==Oa&&!i.svg&&(l=r.display,r.display="block",o=e.parentNode,(!o||!e.offsetParent&&!e.getBoundingClientRect().width)&&(u=1,a=e.nextElementSibling,Oa.appendChild(e)),s=X0(e),l?r.display=l:ks(e,"display"),u&&(a?o.insertBefore(e,a):o?o.appendChild(e):Oa.removeChild(e))),t&&s.length>6?[s[0],s[1],s[4],s[5],s[12],s[13]]:s)},dm=function(e,t,i,r,s,o){var a=e._gsap,l=s||Zg(e,!0),u=a.xOrigin||0,c=a.yOrigin||0,f=a.xOffset||0,h=a.yOffset||0,p=l[0],v=l[1],g=l[2],m=l[3],d=l[4],_=l[5],x=t.split(" "),y=parseFloat(x[0])||0,w=parseFloat(x[1])||0,T,M,P,S;i?l!==Nu&&(M=p*m-v*g)&&(P=y*(m/M)+w*(-g/M)+(g*_-m*d)/M,S=y*(-v/M)+w*(p/M)-(p*_-v*d)/M,y=P,w=S):(T=GM(e),y=T.x+(~x[0].indexOf("%")?y/100*T.width:y),w=T.y+(~(x[1]||x[0]).indexOf("%")?w/100*T.height:w)),r||r!==!1&&a.smooth?(d=y-u,_=w-c,a.xOffset=f+(d*p+_*g)-d,a.yOffset=h+(d*v+_*m)-_):a.xOffset=a.yOffset=0,a.xOrigin=y,a.yOrigin=w,a.smooth=!!r,a.origin=t,a.originIsAbsolute=!!i,e.style[si]="0px 0px",o&&(_s(o,a,"xOrigin",u,y),_s(o,a,"yOrigin",c,w),_s(o,a,"xOffset",f,a.xOffset),_s(o,a,"yOffset",h,a.yOffset)),e.setAttribute("data-svg-origin",y+" "+w)},Iu=function(e,t){var i=e._gsap||new bM(e);if("x"in i&&!t&&!i.uncache)return i;var r=e.style,s=i.scaleX<0,o="px",a="deg",l=getComputedStyle(e),u=Mi(e,si)||"0",c,f,h,p,v,g,m,d,_,x,y,w,T,M,P,S,E,F,N,Z,L,I,V,B,U,O,R,$,Q,q,K,re;return c=f=h=g=m=d=_=x=y=0,p=v=1,i.svg=!!(e.getCTM&&WM(e)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(r[Ft]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[Ft]!=="none"?l[Ft]:"")),r.scale=r.rotate=r.translate="none"),M=Zg(e,i.svg),i.svg&&(i.uncache?(U=e.getBBox(),u=i.xOrigin-U.x+"px "+(i.yOrigin-U.y)+"px",B=""):B=!t&&e.getAttribute("data-svg-origin"),dm(e,B||u,!!B||i.originIsAbsolute,i.smooth!==!1,M)),w=i.xOrigin||0,T=i.yOrigin||0,M!==Nu&&(F=M[0],N=M[1],Z=M[2],L=M[3],c=I=M[4],f=V=M[5],M.length===6?(p=Math.sqrt(F*F+N*N),v=Math.sqrt(L*L+Z*Z),g=F||N?Go(N,F)*no:0,_=Z||L?Go(Z,L)*no+g:0,_&&(v*=Math.abs(Math.cos(_*Fa))),i.svg&&(c-=w-(w*F+T*Z),f-=T-(w*N+T*L))):(re=M[6],q=M[7],R=M[8],$=M[9],Q=M[10],K=M[11],c=M[12],f=M[13],h=M[14],P=Go(re,Q),m=P*no,P&&(S=Math.cos(-P),E=Math.sin(-P),B=I*S+R*E,U=V*S+$*E,O=re*S+Q*E,R=I*-E+R*S,$=V*-E+$*S,Q=re*-E+Q*S,K=q*-E+K*S,I=B,V=U,re=O),P=Go(-Z,Q),d=P*no,P&&(S=Math.cos(-P),E=Math.sin(-P),B=F*S-R*E,U=N*S-$*E,O=Z*S-Q*E,K=L*E+K*S,F=B,N=U,Z=O),P=Go(N,F),g=P*no,P&&(S=Math.cos(P),E=Math.sin(P),B=F*S+N*E,U=I*S+V*E,N=N*S-F*E,V=V*S-I*E,F=B,I=U),m&&Math.abs(m)+Math.abs(g)>359.9&&(m=g=0,d=180-d),p=Gt(Math.sqrt(F*F+N*N+Z*Z)),v=Gt(Math.sqrt(V*V+re*re)),P=Go(I,V),_=Math.abs(P)>2e-4?P*no:0,y=K?1/(K<0?-K:K):0),i.svg&&(B=e.getAttribute("transform"),i.forceCSS=e.setAttribute("transform","")||!YM(Mi(e,Ft)),B&&e.setAttribute("transform",B))),Math.abs(_)>90&&Math.abs(_)<270&&(s?(p*=-1,_+=g<=0?180:-180,g+=g<=0?180:-180):(v*=-1,_+=_<=0?180:-180)),t=t||i.uncache,i.x=c-((i.xPercent=c&&(!t&&i.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-c)?-50:0)))?e.offsetWidth*i.xPercent/100:0)+o,i.y=f-((i.yPercent=f&&(!t&&i.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-f)?-50:0)))?e.offsetHeight*i.yPercent/100:0)+o,i.z=h+o,i.scaleX=Gt(p),i.scaleY=Gt(v),i.rotation=Gt(g)+a,i.rotationX=Gt(m)+a,i.rotationY=Gt(d)+a,i.skewX=_+a,i.skewY=x+a,i.transformPerspective=y+o,(i.zOrigin=parseFloat(u.split(" ")[2])||!t&&i.zOrigin||0)&&(r[si]=ed(u)),i.xOffset=i.yOffset=0,i.force3D=Ai.force3D,i.renderTransform=i.svg?aC:VM?jM:oC,i.uncache=0,i},ed=function(e){return(e=e.split(" "))[0]+" "+e[1]},Mh=function(e,t,i){var r=Cn(t);return Gt(parseFloat(t)+parseFloat(zs(e,"x",i+"px",r)))+r},oC=function(e,t){t.z="0px",t.rotationY=t.rotationX="0deg",t.force3D=0,jM(e,t)},qs="0deg",Ml="0px",$s=") ",jM=function(e,t){var i=t||this,r=i.xPercent,s=i.yPercent,o=i.x,a=i.y,l=i.z,u=i.rotation,c=i.rotationY,f=i.rotationX,h=i.skewX,p=i.skewY,v=i.scaleX,g=i.scaleY,m=i.transformPerspective,d=i.force3D,_=i.target,x=i.zOrigin,y="",w=d==="auto"&&e&&e!==1||d===!0;if(x&&(f!==qs||c!==qs)){var T=parseFloat(c)*Fa,M=Math.sin(T),P=Math.cos(T),S;T=parseFloat(f)*Fa,S=Math.cos(T),o=Mh(_,o,M*S*-x),a=Mh(_,a,-Math.sin(T)*-x),l=Mh(_,l,P*S*-x+x)}m!==Ml&&(y+="perspective("+m+$s),(r||s)&&(y+="translate("+r+"%, "+s+"%) "),(w||o!==Ml||a!==Ml||l!==Ml)&&(y+=l!==Ml||w?"translate3d("+o+", "+a+", "+l+") ":"translate("+o+", "+a+$s),u!==qs&&(y+="rotate("+u+$s),c!==qs&&(y+="rotateY("+c+$s),f!==qs&&(y+="rotateX("+f+$s),(h!==qs||p!==qs)&&(y+="skew("+h+", "+p+$s),(v!==1||g!==1)&&(y+="scale("+v+", "+g+$s),_.style[Ft]=y||"translate(0, 0)"},aC=function(e,t){var i=t||this,r=i.xPercent,s=i.yPercent,o=i.x,a=i.y,l=i.rotation,u=i.skewX,c=i.skewY,f=i.scaleX,h=i.scaleY,p=i.target,v=i.xOrigin,g=i.yOrigin,m=i.xOffset,d=i.yOffset,_=i.forceCSS,x=parseFloat(o),y=parseFloat(a),w,T,M,P,S;l=parseFloat(l),u=parseFloat(u),c=parseFloat(c),c&&(c=parseFloat(c),u+=c,l+=c),l||u?(l*=Fa,u*=Fa,w=Math.cos(l)*f,T=Math.sin(l)*f,M=Math.sin(l-u)*-h,P=Math.cos(l-u)*h,u&&(c*=Fa,S=Math.tan(u-c),S=Math.sqrt(1+S*S),M*=S,P*=S,c&&(S=Math.tan(c),S=Math.sqrt(1+S*S),w*=S,T*=S)),w=Gt(w),T=Gt(T),M=Gt(M),P=Gt(P)):(w=f,P=h,T=M=0),(x&&!~(o+"").indexOf("px")||y&&!~(a+"").indexOf("px"))&&(x=zs(p,"x",o,"px"),y=zs(p,"y",a,"px")),(v||g||m||d)&&(x=Gt(x+v-(v*w+g*M)+m),y=Gt(y+g-(v*T+g*P)+d)),(r||s)&&(S=p.getBBox(),x=Gt(x+r/100*S.width),y=Gt(y+s/100*S.height)),S="matrix("+w+","+T+","+M+","+P+","+x+","+y+")",p.setAttribute("transform",S),_&&(p.style[Ft]=S)},lC=function(e,t,i,r,s){var o=360,a=fn(s),l=parseFloat(s)*(a&&~s.indexOf("rad")?no:1),u=l-r,c=r+u+"deg",f,h;return a&&(f=s.split("_")[1],f==="short"&&(u%=o,u!==u%(o/2)&&(u+=u<0?o:-o)),f==="cw"&&u<0?u=(u+o*z0)%o-~~(u/o)*o:f==="ccw"&&u>0&&(u=(u-o*z0)%o-~~(u/o)*o)),e._pt=h=new ri(e._pt,t,i,r,u,WA),h.e=c,h.u="deg",e._props.push(i),h},Y0=function(e,t){for(var i in t)e[i]=t[i];return e},uC=function(e,t,i){var r=Y0({},i._gsap),s="perspective,force3D,transformOrigin,svgOrigin",o=i.style,a,l,u,c,f,h,p,v;r.svg?(u=i.getAttribute("transform"),i.setAttribute("transform",""),o[Ft]=t,a=Iu(i,1),ks(i,Ft),i.setAttribute("transform",u)):(u=getComputedStyle(i)[Ft],o[Ft]=t,a=Iu(i,1),o[Ft]=u);for(l in Zr)u=r[l],c=a[l],u!==c&&s.indexOf(l)<0&&(p=Cn(u),v=Cn(c),f=p!==v?zs(i,l,u,v):parseFloat(u),h=parseFloat(c),e._pt=new ri(e._pt,a,l,f,h-f,um),e._pt.u=v||0,e._props.push(l));Y0(a,r)};ii("padding,margin,Width,Radius",function(n,e){var t="Top",i="Right",r="Bottom",s="Left",o=(e<3?[t,i,r,s]:[t+s,t+i,r+i,r+s]).map(function(a){return e<2?n+a:"border"+a+n});Jf[e>1?"border"+n:n]=function(a,l,u,c,f){var h,p;if(arguments.length<4)return h=o.map(function(v){return Fr(a,v,u)}),p=h.join(" "),p.split(h[0]).length===5?h[0]:p;h=(c+"").split(" "),p={},o.forEach(function(v,g){return p[v]=h[g]=h[g]||h[(g-1)/2|0]}),a.init(l,p,f)}});var qM={name:"css",register:fm,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,i,r,s){var o=this._props,a=e.style,l=i.vars.startAt,u,c,f,h,p,v,g,m,d,_,x,y,w,T,M,P,S;qg||fm(),this.styles=this.styles||HM(e),P=this.styles.props,this.tween=i;for(g in t)if(g!=="autoRound"&&(c=t[g],!(gi[g]&&PM(g,t,i,r,e,s)))){if(p=typeof c,v=Jf[g],p==="function"&&(c=c.call(i,r,e,s),p=typeof c),p==="string"&&~c.indexOf("random(")&&(c=Lu(c)),v)v(this,e,g,c,i)&&(M=1);else if(g.substr(0,2)==="--")u=(getComputedStyle(e).getPropertyValue(g)+"").trim(),c+="",Ls.lastIndex=0,Ls.test(u)||(m=Cn(u),d=Cn(c),d?m!==d&&(u=zs(e,g,u,d)+d):m&&(c+=m)),this.add(a,"setProperty",u,c,r,s,0,0,g),o.push(g),P.push(g,0,a[g]);else if(p!=="undefined"){if(l&&g in l?(u=typeof l[g]=="function"?l[g].call(i,r,e,s):l[g],fn(u)&&~u.indexOf("random(")&&(u=Lu(u)),Cn(u+"")||u==="auto"||(u+=Ai.units[g]||Cn(Fr(e,g))||""),(u+"").charAt(1)==="="&&(u=Fr(e,g))):u=Fr(e,g),h=parseFloat(u),_=p==="string"&&c.charAt(1)==="="&&c.substr(0,2),_&&(c=c.substr(2)),f=parseFloat(c),g in yr&&(g==="autoAlpha"&&(h===1&&Fr(e,"visibility")==="hidden"&&f&&(h=0),P.push("visibility",0,a.visibility),_s(this,a,"visibility",h?"inherit":"hidden",f?"inherit":"hidden",!f)),g!=="scale"&&g!=="transform"&&(g=yr[g],~g.indexOf(",")&&(g=g.split(",")[0]))),x=g in Zr,x){if(this.styles.save(g),S=c,p==="string"&&c.substring(0,6)==="var(--"){if(c=Mi(e,c.substring(4,c.indexOf(")"))),c.substring(0,5)==="calc("){var E=e.style.perspective;e.style.perspective=c,c=Mi(e,"perspective"),E?e.style.perspective=E:ks(e,"perspective")}f=parseFloat(c)}if(y||(w=e._gsap,w.renderTransform&&!t.parseTransform||Iu(e,t.parseTransform),T=t.smoothOrigin!==!1&&w.smooth,y=this._pt=new ri(this._pt,a,Ft,0,1,w.renderTransform,w,0,-1),y.dep=1),g==="scale")this._pt=new ri(this._pt,w,"scaleY",w.scaleY,(_?Ia(w.scaleY,_+f):f)-w.scaleY||0,um),this._pt.u=0,o.push("scaleY",g),g+="X";else if(g==="transformOrigin"){P.push(si,0,a[si]),c=rC(c),w.svg?dm(e,c,0,T,0,this):(d=parseFloat(c.split(" ")[2])||0,d!==w.zOrigin&&_s(this,w,"zOrigin",w.zOrigin,d),_s(this,a,g,ed(u),ed(c)));continue}else if(g==="svgOrigin"){dm(e,c,1,T,0,this);continue}else if(g in XM){lC(this,w,g,h,_?Ia(h,_+c):c);continue}else if(g==="smoothOrigin"){_s(this,w,"smooth",w.smooth,c);continue}else if(g==="force3D"){w[g]=c;continue}else if(g==="transform"){uC(this,c,e);continue}}else g in a||(g=tl(g)||g);if(x||(f||f===0)&&(h||h===0)&&!GA.test(c)&&g in a)m=(u+"").substr((h+"").length),f||(f=0),d=Cn(c)||(g in Ai.units?Ai.units[g]:m),m!==d&&(h=zs(e,g,u,d)),this._pt=new ri(this._pt,x?w:a,g,h,(_?Ia(h,_+f):f)-h,!x&&(d==="px"||g==="zIndex")&&t.autoRound!==!1?jA:um),this._pt.u=d||0,x&&S!==c?(this._pt.b=u,this._pt.e=S,this._pt.r=YA):m!==d&&d!=="%"&&(this._pt.b=u,this._pt.r=XA);else if(g in a)iC.call(this,e,g,u,_?_+c:c);else if(g in e)this.add(e,g,u||e[g],_?_+c:c,r,s);else if(g!=="parseTransform"){kg(g,c);continue}x||(g in a?P.push(g,0,a[g]):typeof e[g]=="function"?P.push(g,2,e[g]()):P.push(g,1,u||e[g])),o.push(g)}}M&&OM(this)},render:function(e,t){if(t.tween._time||!$g())for(var i=t._pt;i;)i.r(e,i.d),i=i._next;else t.styles.revert()},get:Fr,aliases:yr,getSetter:function(e,t,i){var r=yr[t];return r&&r.indexOf(",")<0&&(t=r),t in Zr&&t!==si&&(e._gsap.x||Fr(e,"x"))?i&&k0===i?t==="scale"?ZA:KA:(k0=i||{})&&(t==="scale"?QA:JA):e.style&&!Ig(e.style[t])?qA:~t.indexOf("-")?$A:Yg(e,t)},core:{_removeProperty:ks,_getMatrix:Zg}};ui.utils.checkPrefix=tl;ui.core.getStyleSaver=HM;(function(n,e,t,i){var r=ii(n+","+e+","+t,function(s){Zr[s]=1});ii(e,function(s){Ai.units[s]="deg",XM[s]=1}),yr[r[13]]=n+","+e,ii(i,function(s){var o=s.split(":");yr[o[1]]=r[o[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");ii("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(n){Ai.units[n]="px"});ui.registerPlugin(qM);var Xu=ui.registerPlugin(qM)||ui;Xu.core.Tween;function cC(n,e){for(var t=0;t<e.length;t++){var i=e[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(n,i.key,i)}}function fC(n,e,t){return e&&cC(n.prototype,e),n}/*!
 * Observer 3.15.0
 * https://gsap.com
 *
 * @license Copyright 2008-2026, GreenSock. All rights reserved.
