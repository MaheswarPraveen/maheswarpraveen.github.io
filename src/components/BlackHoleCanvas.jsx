...
export default function BlackHoleCanvas() {
  ...
  useEffect(() => {
    ...
    // ------------------------------------------------------------------------
    // 4. ACCRETION DISK: 24,000 LENGTHY PARTICLES (OPTIMIZED GC)
    // ------------------------------------------------------------------------
    ...
    // ------------------------------------------------------------------------
    // 8. MASTER CAMERA TIMELINE (Continuous Tilt — Zero Flash Overlay)
    // ------------------------------------------------------------------------
    ...
    // Expose black hole 2D projection function globally for character swallow calculations
